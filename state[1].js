var states = ["SELECT YOUR STATE","Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chhattisgarh","Dadra and Nagar Haveli","Daman and Diu","Delhi","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka",
...
function selct_district($val)
{
	...
	{
		var andhra = ["Select your District","Anantapur","Chittoor","East Godavari","Guntur","Krishna","Kurnool","Prakasam","Srikakulam","Nellore",
	...
	{
		var ap = ["Select your District","Anjaw","Changlang","Dibang Valley","East Siang","East Kameng","Kurung Kumey","Lohit","Longding","Lower Dibang Valley","Lower Subansiri","Papum Pare",
	...
	if ($val=='Assam') 
	{
		var assam = ["Select your District","Baksa","Barpeta","Bongaigaon","Cachar","Chirang","Darrang","Dhemaji","Dima Hasao","Dhubri","Dibrugarh","Goalpara","Golaghat","Hailakandi","Jorhat",
	...
	if ($val=='Bihar') 
	{
		var bihar = ["Select your District","Araria","Arwal","Aurangabad","Banka","Begusarai","Bhagalpur","Bhojpur","Buxar","Darbhanga","East Champaran","Gaya","Gopalganj","Jamui","Jehanabad","Kaimur",
	...
	if ($val=='Chhattisgarh') 
	{
		var Chhattisgarh = ["Select your District","Bastar","Bijapur","Bilaspur","Dantewada","Dhamtari","Durg","Jashpur","Janjgir-Champa","Korba","Koriya","Kanker","Kabirdham (formerly Kawardha)","Mahasamund",
	...
	{
		var dadra = ["Select your District","Amal","Silvassa"];
		$(function() 
		{
			var options = '';
	...
	{
		var daman = ["Select your District","Daman","Diu"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Delhi') 
	{
		var delhi = ["Select your District","Delhi","New Delhi","North Delhi","Noida","Patparganj","Sonabarsa","Tughlakabad"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Goa') 
	{
		var goa = ["Select your District","Chapora","Dabolim","Madgaon","Marmugao (Marmagao)","Panaji Port","Panjim","Pellet Plant Jetty/Shiroda","Talpona","Vasco da Gama"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Gujarat') 
	{
		var gujarat = ["Select your District","Ahmedabad","Amreli district","Anand","Aravalli","Banaskantha","Bharuch","Bhavnagar","Dahod","Dang","Gandhinagar","Jamnagar","Junagadh",
	...
	if ($val=='Haryana') 
	{
		var haryana = ["Select your District","Ambala","Bhiwani","Faridabad","Fatehabad","Gurgaon","Hissar","Jhajjar","Jind","Karnal","Kaithal",
	...
	{
		var himachal = ["Select your District","Baddi","Baitalpur","Chamba","Dharamsala","Hamirpur","Kangra","Kinnaur","Kullu","Lahaul & Spiti","Mandi","Simla","Sirmaur","Solan","Una"];
		$(function() 
		{
			var options = '';
	...
	{
		var jammu = ["Select your District","Jammu","Leh","Rajouri","Srinagar"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Jharkhand') 
	{
		var jharkhand = ["Select your District","Bokaro","Chatra","Deoghar","Dhanbad","Dumka","East Singhbhum","Garhwa","Giridih","Godda","Gumla","Hazaribag","Jamtara","Khunti","Koderma","Latehar","Lohardaga","Pakur","Palamu",
	...
	if ($val=='Karnataka') 
	{
		var karnataka = ["Select your District","Bagalkot","Bangalore","Bangalore Urban","Belgaum","Bellary","Bidar","Bijapur","Chamarajnagar", "Chikkamagaluru","Chikkaballapur",
	...
	if ($val=='Kerala') 
	{
		var kerala = ["Select your District","Alappuzha","Ernakulam","Idukki","Kannur","Kasaragod","Kollam","Kottayam","Kozhikode","Malappuram","Palakkad","Pathanamthitta","Thrissur","Thiruvananthapuram","Wayanad"];
		$(function() 
		{
			var options = '';
	...
	{
		var mp = ["Select your District","Alirajpur","Anuppur","Ashoknagar","Balaghat","Barwani","Betul","Bhilai","Bhind","Bhopal","Burhanpur","Chhatarpur","Chhindwara","Damoh","Dewas","Dhar","Guna","Gwalior","Hoshangabad",
	...
	if ($val=='Maharashtra') 
	{
		var maharashtra = ["Select your District","Ahmednagar","Akola","Alibag","Amaravati","Arnala","Aurangabad","Aurangabad","Bandra","Bassain","Belapur","Bhiwandi","Bhusaval","Borliai-Mandla","Chandrapur","Dahanu","Daulatabad","Dighi (Pune)","Dombivali","Goa","Jaitapur","Jalgaon",
	...
	if ($val=='Manipur') 
	{
		var manipur = ["Select your District","Bishnupur","Churachandpur","Chandel","Imphal East","Senapati","Tamenglong","Thoubal","Ukhrul","Imphal West"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Meghalaya') 
	{
		var meghalaya = ["Select your District","Baghamara","Balet","Barsora","Bolanganj","Dalu","Dawki","Ghasuapara","Mahendraganj","Moreh","Ryngku","Shella Bazar","Shillong"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Mizoram') 
	{
		var mizoram = ["Select your District","Aizawl","Champhai","Kolasib","Lawngtlai","Lunglei","Mamit","Saiha","Serchhip"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Nagaland') 
	{
		var nagaland = ["Select your District","Dimapur","Kiphire","Kohima","Longleng","Mokokchung","Mon","Peren","Phek","Tuensang","Wokha","Zunheboto"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Orissa') 
	{
		var orissa = ["Select your District","Bahabal Pur","Bhubaneswar","Chandbali","Gopalpur","Jeypore","Paradip Garh","Puri","Rourkela"];
		$(function() 
		{
			var options = '';
	...
	if ($val=='Puducherry') 
	{
		var puducherry = ["Select your District","Karaikal","Mahe","Pondicherry","Yanam"];
		$(function() 
		{
			var options = '';
    ...
    if ($val=='Punjab') 
	{
		var punjab = ["Select your District","Amritsar","Barnala","Bathinda","Firozpur","Faridkot","Fatehgarh Sahib","Fazilka","Gurdaspur","Hoshiarpur","Jalandhar","Kapurthala","Ludhiana","Mansa","Moga","Sri Muktsar Sahib","Pathankot",
	...
	if ($val=='Rajasthan') 
	{
		var rajasthan = ["Select your District","Ajmer","Banswara","Barmer","Barmer Rail Station","Basni","Beawar","Bharatpur","Bhilwara","Bhiwadi","Bikaner","Bongaigaon","Boranada, Jodhpur","Chittaurgarh","Fazilka","Ganganagar","Jaipur","Jaipur-Kanakpura",
    ...
    if ($val=='Sikkim') 
	{
		var sikkim = ["Select your District","Chamurci","Gangtok"];
		$(function() 
		{
			var options = '';
    ...
    if ($val=='Tamil Nadu') 
	{
		var tn = ["Select your District","Ariyalur","Chennai","Coimbatore","Cuddalore","Dharmapuri","Dindigul","Erode","Kanchipuram","Kanyakumari","Karur","Krishnagiri","Madurai","Mandapam","Nagapattinam","Nilgiris","Namakkal","Perambalur","Pudukkottai","Ramanathapuram","Salem","Sivaganga","Thanjavur","Thiruvallur","Tirupur",
    ...
    if ($val=='Telangana') 
	{
		var telangana = ["Select your District","Adilabad","Bhadradri Kothagudem","Hyderabad","Jagtial","Jangaon","Jayashankar Bhupalapally",
					   "Jogulamba Gadwal","Kamareddy","Karimnagar","Khammam","Kumarambheem Asifabad","Mahabubabad",
					   "Mahabubnagar","Mancherial","Medak","Medchal–Malkajgiri","Nagarkurnool","Nalgonda","Nirmal",
    ...
    if ($val=='Tripura') 
	{
		var tripura = ["Select your District","Agartala","Dhalaighat","Kailashahar","Kamalpur","Kanchanpur","Kel Sahar Subdivision","Khowai","Khowaighat","Mahurighat","Old Raghna Bazar","Sabroom","Srimantapur"];
		$(function() 
		{
			var options = '';
	...
	{
		var up = ["Select your District","Agra","Allahabad","Auraiya","Banbasa","Bareilly","Berhni","Bhadohi","Dadri","Dharchula","Gandhar","Gauriphanta","Ghaziabad","Gorakhpur","Gunji",
    ...
    if ($val=='Uttarakhand') 
	{
		var uttarakhand = ["Select your District","Almora","Badrinath","Bangla","Barkot","Bazpur","Chamoli","Chopra","Dehra Dun","Dwarahat","Garhwal","Haldwani","Hardwar","Haridwar","Jamal","Jwalapur","Kalsi","Kashipur","Mall",
    ...
    if ($val=='West Bengal') 
	{
		var wb = ["Select your District","Alipurduar","Bankura","Bardhaman","Birbhum","Cooch Behar","Dakshin Dinajpur","Darjeeling","Hooghly","Howrah",
